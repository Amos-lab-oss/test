...
int main(void)
{
	...
	TIM_BASE_Init(10-1,8400-1);//ÅäÖÃ¶¨Ê±Æ÷4Îª1msÖĞ¶ÏÒ»´Î£¬×öÀ´ÏµÍ³ÔwËĞĞ¼ÆÊı£¬±ãÓÚÖ®ºóÊµÏÖÒ»Ğ©ÑÓÊ±²Ù×÷
...
//	TIM12_DEVICE(400-1,90-1);//·äÃùÆ÷£¬PWMÆµÂÊÔÚ2700HZÊ±ÉùÒô×î´ó£¬ÇÒÕ¼¿Õ±ÈĞèÒªÉèÖÃ³É5£¥µÄ¸ßµçÆ½£¬´Ë´¦ÉèÖÃÎª2500HZ
  TIM10_DEVICE(5000-1,0);//Ìá¹©Ò»Â·PWMÊ¹µÃ¼ÓÈÈµç×èÉıÎÂ£¬ÓÃÓÚºãÎÂ¼ÓÈÈIMU
	CAN1_DEVICE(CAN_Mode_Normal, CAN_SJW_1tq, CAN_BS1_10tq, CAN_BS2_3tq, 3);//CAN1ÅäÖÃ
	...
	USART1_DEVICE();//ÓÃÓÚPCÍ¨ĞÅÊı¾İ£¬²ÉÓÃµÄÊÇDMA¼Ó¿ÕÏĞÖĞ¶ÏµÄ·½Ê½½ÓÊÕÊı¾İ
